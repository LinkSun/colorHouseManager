    ...
    <div class="app-container calendar-list-container">
        <div class="filter-container">
            ...
            <el-form :inline="true" :model="query" class="demo-form-inline">
                <el-form-item label="">
                    <el-input v-model="query.identity_name" clearable placeholder="推荐人姓名"></el-input>
                </el-form-item>
                <el-form-item label="">
                    <el-input v-model="query.mobile" clearable placeholder="推荐人手机"></el-input>
                </el-form-item>
                <el-form-item label="">
                    <el-select v-model="query.status" clearable placeholder="处理状态">
                        <el-option v-for="(value, key) in recommenderStatus" :key="key" :label="value" :value="key"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item>
        ...
        border fit highlight-current-row style="width: 100%;" @selection-change="handleSelectionChange">
            ...
            <el-table-column align="center" label="推荐人手机">
                <template scope="scope">
            ...
            <el-table-column align="center" label="被推荐人手机">
                <template scope="scope">
            ...
            <el-table-column align="center" label="处理状态">
                <template scope="scope">
                    <span :style="scope.row.status | formatColor">{{ recommenderStatus[scope.row.status] || ''}}</span>
                </template>
            </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                ...
                httpClient.get('admin/building/recommend/' + this.id, { params: this.query }).then(response => {
                    const data = response.content
                    this.list = data.list
                    this.total = data.total
                    this.building = data.building
                    this.recommenderStatus = data.recommenderStatus
            ...
            doing(id) {
                ...
                this.$confirm('确认要设置处理中操作吗？')
                    .then(_=> {
                        httpClient.post('admin/building/recommend/' + id, {status: 1}).then(response => {
                            this.getList()
                            this.$message({
                                type: 'success',
                                message: '操作成功'
            ...
            finish(id) {
                this.$confirm('确认要设置已处理操作吗？')
                    .then(_=> {
                        httpClient.post('admin/building/recommend/' + id, {status: 2}).then(response => {
                            this.getList()
                            this.$message({
                                type: 'success',
                                message: '操作成功'
